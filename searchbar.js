const pages = [
    ...
    { display: 'Olin Jazz Orchestra', name: 'olin jazz orchestra', href: 'OJO.html' },
    { display: 'Olin Conductorless Orchestra', name: 'oco', href: 'Olin-Conductorless-Orchestra.html' },
    ...
    { display: 'Olin Rock Orchestra', name: 'olin rock orchestra', href: 'ORO.html' },
    { display: 'People', name: 'people', href:'People.html' },
    { display: 'PowerChords', name: 'powerchords', href: 'PowerChords.html' },
    { display: 'PPE Information', name: 'ppe information', href: 'PPE-Information.html'},
